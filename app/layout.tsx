    ...
    <html lang="en">
      ...
      <body>
        <header className="top">
          ...
          <nav className="navlinks"><Link href="/">Reels</Link><Link href="/next">Next reel</Link><Link href="/experiments">Experiments</Link><Link href="/competitors">Competitors</Link></nav>
